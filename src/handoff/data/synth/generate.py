...
SCENARIOS: list[dict] = [
    ...
    # --- harder cases (expanded library, v2) ---
    {
        "key": "smoking_light_switch",
        "raw": "There's smoke coming out of my bedroom light switch right now!",
        "photos": [],
        "expect_urgency": Urgency.EMERGENCY,
        "expect_category": Trade.ELECTRICAL,
    },
    {
        ...
        "raw": "Fridge stopped cooling yesterday, light still works inside. All our food is warming up.",
        "photos": [],
        "expect_urgency": Urgency.URGENT,
        "expect_category": Trade.APPLIANCE,
    },
    {
        "key": "burning_smell_heater",
        "raw": "The heater turns on fine but there's a burning smell the first few minutes every time.",
        "photos": [],
        "expect_urgency": Urgency.EMERGENCY,
        "expect_category": Trade.HVAC,
    },
    {
        "key": "co_detector_beeping",
        "raw": "The carbon monoxide detector keeps beeping intermittently even after I changed the battery.",
        "photos": [],
        "expect_urgency": Urgency.EMERGENCY,
    ...
    {
        "key": "power_out_storm",
        "raw": "Whole apartment lost power after last night's storm, breakers all look fine.",
        "photos": [],
        "expect_urgency": Urgency.EMERGENCY,
        "expect_category": Trade.ELECTRICAL,
    },
    {
        "key": "sink_backing_into_dishwasher",
        "raw": "When the washing machine drains, dirty water backs up into the kitchen sink.",
        "photos": [],
        "expect_urgency": Urgency.URGENT,
        "expect_category": Trade.PLUMBING,
    },
    {
        "key": "ceiling_stain_growing",
        "raw": "There's a brown stain on the bedroom ceiling that's definitely gotten bigger over the past week.",
        "photos": ["yellow-brown discoloration on ceiling"],
        "expect_urgency": Urgency.URGENT,
        "expect_category": Trade.PLUMBING,
    },
    {
        "key": "shower_no_hot_water_only",
        "raw": "Kitchen sink gets hot water fine but the shower only ever runs cold.",
        "photos": [],
        "expect_urgency": Urgency.URGENT,
        "expect_category": Trade.PLUMBING,
    },
    {
        "key": "door_lock_loose",
        "raw": "Front door lock is really loose and sometimes doesn't latch unless you slam it.",
        "photos": [],
        "expect_urgency": Urgency.URGENT,
        "expect_category": Trade.LOCKSMITH,
    },
    {
        "key": "window_wont_close_rain",
        "raw": "Living room window won't close all the way and rain is forecast tonight.",
        "photos": ["gap of about two inches in window frame"],
        "expect_urgency": Urgency.URGENT,  # active weather intrusion risk
        "expect_category": Trade.GENERAL,
    },
    {
        "key": "glass_in_hallway",
        "raw": "Kids broke a glass shelf in the hallway closet, shards went into the carpet.",
        "photos": ["broken glass fragments on carpet"],
        "expect_urgency": Urgency.URGENT,
        "expect_category": Trade.GENERAL,
    },
    {
        "key": "wasp_nest_by_door",
        "raw": "There's a wasp nest forming right above our front door handle.",
        "photos": [],
        "expect_urgency": Urgency.ROUTINE,
        "expect_category": Trade.GENERAL,
    },
    {
        "key": "toilet_running",
        "raw": "The toilet runs constantly after flushing unless you jiggle the handle.",
        "photos": [],
        "expect_urgency": Urgency.ROUTINE,
        "expect_category": Trade.PLUMBING,
    },
    {
        "key": "disposal_hums",
        "raw": "Garbage disposal just hums when I flip the switch, blades don't move.",
        "photos": [],
        "expect_urgency": Urgency.ROUTINE,
        "expect_category": Trade.APPLIANCE,
    },
